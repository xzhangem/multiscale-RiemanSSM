...
For performance testing, *evaluate_distance.py* file measures the Chamfer distance, earth moving distance and surface-to-surface distance.
***Notice***: *use_scale* parameter can be set "True (False)" 
